...
class ViewController: UIViewController {
    ...
    var toDoArray = ["Meep", "Celine Dion", "HELLO"]
    var toDoNotesArray = ["Say this in a park","Visit her in Las Vegas", "Say this to friends I haven't talked to in a long time"]
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "EditItem" {
            ...
            let index = tableView.indexPathForSelectedRow!.row //.row gives us the number
